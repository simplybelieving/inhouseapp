angular.module('clientControllers', ['clientServices', 'ui.bootstrap', 'angular-loading-bar'])
...
$http.post('/api/editPricelist', {discount:this.pricelistArray[$index].discount, client_type:type, productname:this.pricelistArray[$index]._productname, newPrice:this.pricelistArray[$index].price, product_id:this.pricelistArray[$index]._id} ).then(function(data){
